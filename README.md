...
???????????????                    ????????????????                  ????????????????
       ...
       ?????????????????????????????????????                                ?
       ?                                   ?                                ?
       ?  10. Store tokens in cookie       ?                                ?
       ?  11. Store access token in       ?                                ?
       ?      claims for later use        ?                                ?
       ?                                   ?                                ?
       ...
       ?  Bearer <accessToken>             ?                                ?
       ?????????????????????????????????????                                ?
       ?                                   ?  14. Validate token signature  ?
       ?                                   ?  15. Check expiration          ?
       ?                                   ?  16. Extract claims            ?
       ?                                   ?                                ?
       ?                                   ?  17. Check user IsActive       ?
       ?                                   ??????????????????????????????????
       ?                                   ??????????????????????????????????
       ?                                   ?  18. User active? Return data  ?
       ...
       ?????????????????????????????????????                                ?
       ?                                   ?  21. Token expired!            ?
       ?  401 Unauthorized                 ?  Return 401                    ?
       ?????????????????????????????????????                                ?
       ?                                   ?                                ?
       ?  22. Detect 401 (via handler)     ?                                ?
       ?  POST /api/auth/refresh-token     ?                                ?
       ?  { refreshToken, accessToken }   ?                                ?
       ?????????????????????????????????????                                ?
       ?                                   ?  23. Validate refresh token    ?
       ?                                   ?  24. Check expiration          ?
       ?                                   ?  25. Verify not revoked        ?
       ?                                   ??????????????????????????????????
       ?                                   ??????????????????????????????????
       ?                                   ?  26. Refresh token valid       ?
       ?                                   ?                                ?
       ?                                   ?  27. Create new access token   ?
       ?                                   ?  28. Create new refresh token  ?
       ?                                   ?  29. Mark old refresh revoked  ?
       ?                                   ??????????????????????????????????
       ?                                   ??????????????????????????????????
       ?                                   ?  30. Tokens stored             ?
       ...
       ?????????????????????????????????????                                ?
       ?                                   ?                                ?
       ?  32. Update stored tokens         ?                                ?
       ?  33. Retry original request       ?                                ?
