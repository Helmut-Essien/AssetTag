...
public class AssetsController : ControllerBase
{
    ...
    public AssetsController(ApplicationDbContext context, IAssetImportService assetImportService)
    {
        _context = context;
    ...
    [HttpGet("{id}")]
        ...
        public async Task<ActionResult<AssetImportResultDTO>> BatchImport(
            IFormFile file,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (file.Length > AssetImportService.MaxFileBytes)
            ...
            try
            {
                ...
                var result = await _assetImportService.ImportAsync(
                    stream,
                    userId,
                    validateOnly,
                    cancellationToken);
